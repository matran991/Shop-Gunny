...
function allLoaded(){
    context.drawImage(object_num[0],170,0);
    context.drawImage(object_num[1],180,30);
    context.drawImage(object_num[2],170,0);
    context.drawImage(object_num[3],170,0);
    context.drawImage(object_num[4],170,0);
    context.drawImage(object_num[5],170,0);
    context.drawImage(object_num[6],170,0);
...
function canvas_run(){
  if(item_bo == false){
    ...
    var url = 'https://cdn.rawgit.com/matran991/Shop-Gunny/master/Nam/Bo/'+object_item.Bo+'.png';
    draw_bo(url, 120, 150);
    context.drawImage(object_num[7],5,40);
    context.drawImage(object_num[8],45,30);
  }
